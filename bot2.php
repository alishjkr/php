...
if ($type == 'join' || $command == 'Help') {
    $text = "By : Ali Ahmadi ( Alish Joker ) line.me/ti/p/~alishjkr\n";
    $text .= "Keyword HalloBot \n";
    $text .= "> 1A\n";
    $text .= "> 2B\n";
    $text .= "> F2\n";
    $text .= "> F3\n";
    ...
    $text .= "> \n";
    $text .= "> \n";
    $text .= "> /say reply your text کپی متن  ‌شما\n";
    $text .= "> \n";
    $text .= "> \n";
    $text .= "> \n";
    $text .= "> \n";
